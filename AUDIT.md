...
**Guide status: Reviewed. 15/15 questions reviewed, TOC added, version-baseline header present. Basic-only by design — see `README.md`'s "Difficulty by guide" table.**
